...
class AboutNil < EdgeCase::Koan
  ...
  def test_nil_has_a_few_methods_defined_on_it
    ...
    # I vote for obj.nil? as the better and more flexible choice.
    #I can arbitrarily def nil? return true; end on a NullObject implementation, for example.
    #Benchmarks of both are about equal.
  end
