...
class AboutMessagePassing < EdgeCase::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # __send__ is a handy backup of send just in case send gets redefined.
  end
  ...
  def test_exceptions_from_sending_undefined_messages_mention_the_message
    typical = TypicalObject.new
    begin
      typical.foobar
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    # The whole magic of dynamic method creation!
  end
