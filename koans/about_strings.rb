...
It was the worst of times.
EOS
    # Note here documents omit the initial \n at the start of the string,
    # unlike flexible quotes, thus the string length is less by 1.
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # It's considerably faster, since the shovel operator doesn't perform
    # a copy on the original string or incur the resulting garbage
    # collection overhead.
  end
  ...
  def test_you_can_get_a_single_character_from_a_string
    ...
    # Surprised?
    # Array references into a String are the Fixnum character value (ASCII)
  end
