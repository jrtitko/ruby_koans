...
class AboutClassMethods < EdgeCase::Koan
  ...
  # I prefer the self.method form since it succinctly annotates the method on the class.
  #
  # The value of the class << self block is that it allows easy moving of a block of
  # methods to the class scope by simply pasting the method in the block.  Once the
  # dust settles, though, I tend to rewrite them as self.method signatures.
  
  
  # Are there times you might prefer one over the other?
  # class << self is good during quick coding and refactoring runs.
  # I find self.method to be qucker reading and more reliably perceived intent in
  # the long term.
